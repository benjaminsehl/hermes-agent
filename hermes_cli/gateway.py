...
_PLATFORMS = [
    ...
    },
    {
        ...
        "vars": [
            ...
            {"name": "BLUEBUBBLES_ALLOWED_USERS", "prompt": "Allowed phone numbers or iMessage IDs (comma-separated)", "password": False,
             "is_allowlist": True,
             "help": "Only messages from these senders will be processed."},
